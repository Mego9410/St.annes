  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        warm: "bg-accent-warm text-accent-warm-foreground shadow-sm hover:brightness-105",
        "primary-inverse": "bg-white text-foreground shadow-sm hover:bg-white/95",
        "outline-inverse": "border-2 border-white bg-transparent text-white hover:bg-white/15",
      ...
      size: {
        ...
        icon: "h-9 w-9 min-h-[44px] min-w-[44px] md:h-9 md:w-9 md:min-h-0 md:min-w-0 rounded-xl",
        touch: "h-11 min-h-[44px] min-w-[44px] rounded-xl px-6 text-base",
      },
    },
    defaultVariants: {
      variant: "default",
